            ...
            <div class="panel-body">
                ...
                <form class="form-horizontal" action="" data-parsley-validate="true" method="post" enctype="multipart/form-data">
                  <div class="form-group">
                    ...
                    <div class="col-lg-9">
                      <input type="text" name="ket_slide" class="form-control" value="<?php echo $query->ket_slide; ?>" placeholder="Keterangan Foto Slide" required autofocus onfocus="this.value = this.value;">
                    </div>
                  </div>
                  <div class="form-group">
