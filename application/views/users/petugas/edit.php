              ...
              ?>
                ...
                <div class="card">
                  ...
                  <input type="text" name="nama" class="form-control" value="<?php echo $query->nama; ?>" placeholder="Nama" required autofocus onfocus="this.value = this.value;">
                    ...
                    <div class="form-group">
                    <label>Alamat</label>
                  <input type="text" name="alamat" class="form-control" value="<?php echo $query->alamat; ?>" placeholder="Masukkan Alamat" required autofocus onfocus="this.value = this.value;">
                    </div>
                    <div class="form-group">
                    <label>No. Telp</label>
                  <input type="text" name="no_telp" class="form-control" value="<?php echo $query->no_telp; ?>" placeholder="Masukkan No. Telp" required autofocus onfocus="this.value = this.value;">
                    </div> 
                    <div class="form-group">
                    <label>Email</label>
                  <input type="text" name="email" class="form-control" value="<?php echo $query->email; ?>" placeholder="Masukkan Email" required autofocus onfocus="this.value = this.value;">
                    </div> 
                    <div class="form-group">
                    <label>Username</label>
                  <input type="text" name="username" class="form-control" value="<?php echo $query->user_login; ?>" placeholder="Masukkan Username" required autofocus onfocus="this.value = this.value;">
                    </div> 
                    <div class="form-group">
